...
const constexpr char *annotated_route =
    "{\"code\":\"Ok\",\"routes\":[{\"departure\":\"0\",\"arrival\":\"6000\",\"duration\":\"6000\","
    "\"legs\":[{\"departure\":\"0\",\"arrival\":\"6000\",\"duration\":\"6000\",\"segments\":[{"
    "\"departure\":\"4200\",\"arrival\":\"6000\",\"duration\":\"1800\",\"geometry\":\"g^g^?S?S?I?I?"
    "I?I?I?I\",\"stops\":[{\"name\":\"Stop A Platform "
    "2\",\"arrival\":\"3600\",\"departure\":\"4200\",\"location\":[0.005000,0.004900]},{\"name\":"
    "\"Stop "
    "B\",\"arrival\":\"4800\",\"departure\":\"4800\",\"location\":[0.015200,0.005000]},{\"name\":"
    "\"Stop "
    "C\",\"arrival\":\"5400\",\"departure\":\"5400\",\"location\":[0.025300,0.005000]},{\"name\":"
    "\"Stop "
    "D\",\"arrival\":\"6000\",\"departure\":\"6000\",\"location\":[0.035400,0.005000]}],"
...
BOOST_AUTO_TEST_CASE(request_route)
{
    ...
    else
    {
        ...
        BOOST_CHECK_EQUAL(annotated_route, json);
